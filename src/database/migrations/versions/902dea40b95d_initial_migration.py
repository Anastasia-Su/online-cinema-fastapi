...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_movies_comment_count"), "movies", ["comment_count"], unique=False
    )
    op.create_index(
        op.f("ix_movies_favorite_count"), "movies", ["favorite_count"], unique=False
    )
    op.create_index(
        op.f("ix_movies_like_count"), "movies", ["like_count"], unique=False
    )
    op.create_index(
        op.f("ix_movies_rating_count"), "movies", ["rating_count"], unique=False
    )
    op.create_table(
        "users",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["movie_comments.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "PAID", "REFUNDED", "CANCELED", name="order_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("SUCCESSFUL", "REFUNDED", name="payment_status_enum"),
            nullable=False,
        ),
