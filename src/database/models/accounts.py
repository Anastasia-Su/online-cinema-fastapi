...
# from src.database.models.movies.movies_actions import UserFavoriteMovieModel
...
class UserModel(Base):
    ...
    activation_tokens: Mapped[list[Optional["ActivationTokenModel"]]] = relationship(
        "ActivationTokenModel", back_populates="user", cascade="all, delete-orphan"
    )

    password_reset_tokens: Mapped[list[Optional["PasswordResetTokenModel"]]] = (
        relationship(
